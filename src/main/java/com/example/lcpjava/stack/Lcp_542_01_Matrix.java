...
public class Lcp_542_01_Matrix {
	 ...
	 * 			
	 * 			if nextRow is lower than zero || nextCol is lower than zero || nextRow is greater than or equal to rows || nextCol is greater than or equal to cols || matrix[row][col] is not equal to negative one
	 * 				continue
	 * 			end if
	 * 			
