...
class Lcp_212_Word_Search_IITest {
	
	private Lcp_212_Word_Search_II lcp;
	
	@BeforeEach
	void beforeEach() {
		lcp = new Lcp_212_Word_Search_II();
	}
	...
	void test_case_1() {
		...
		List<String> expected = Arrays.asList(new String[] { "eat", "oath" });
		
		// Act
		List<String> actual = lcp.findWords(board, words);
	...
	void test_case_3() {
		...
		String[] words = { "oa", "oaa" };
		List<String> expected = Arrays.asList(new String[] { "oa", "oaa" });
	...
	void test_case_4() {
		...
		List<String> expected = Arrays.asList(new String[] { "eaafgdcba", "eaabcdgfa" });
	...
	void test_case_5() {
		...
		List<String> expected = Arrays.asList(new String[] { "aaaaaaaacb", "aaaaaaaagf", "aaaaaaaaon", "aaaaaaaasr",
				"aaaaaaaakj", "aaaaaaaawv", "aaaaaaaabm", "aaaaaaaabc", "aaaaaaaafg", "aaaaaaaajk", "aaaaaaaano",
				"aaaaaaaars", "aaaaaaaavw", "aaaaaaaadc", "aaaaaaaahg", "aaaaaaaapo", "aaaaaaaats", "aaaaaaaalk",
				"aaaaaaaacd", "aaaaaaaagh", "aaaaaaaaop", "aaaaaaaast", "aaaaaaaakl", "aaaaaaaawx", "aaaaaaaaed",
				"aaaaaaaaih", "aaaaaaaaqp", "aaaaaaaaut", "aaaaaaaayx", "aaaaaaaade", "aaaaaaaahi", "aaaaaaaapq",
				"aaaaaaaatu", "aaaaaaaaay", "aaaaaaaaaz", "aaaaaaaafe", "aaaaaaaaji", "aaaaaaaanm", "aaaaaaaarq",
				"aaaaaaaavu", "aaaaaaaazy", "aaaaaaaaas", "aaaaaaaaat", "aaaaaaaaaq", "aaaaaaaaar", "aaaaaaaaaw",
				"aaaaaaaaau", "aaaaaaaaav", "aaaaaaaaak", "aaaaaaaaal", "aaaaaaaaai", "aaaaaaaaaj", "aaaaaaaaao",
				"aaaaaaaaap", "aaaaaaaaan", "aaaaaaaaac", "aaaaaaaaad", "aaaaaaaaaa", "aaaaaaaaef", "aaaaaaaaij",
				"aaaaaaaaqr", "aaaaaaaauv", "aaaaaaaaab", "aaaaaaaayz", "aaaaaaaaag", "aaaaaaaaah", "aaaaaaaaza",
	...
	void test_case_6() {
		...
		List<String> expected = Arrays.asList( new String[] { "oath", "oathk", "oathf", "oathfi", "oathfii", "oathi", "oathii", "oate", "eat" });
